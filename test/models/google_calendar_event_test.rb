...
class GoogleCalendarEventTest < ActiveSupport::TestCase
  test "#new_schedule" do
    ...
    travel_to("2021-01-02T00:00:00+09:00")
    ...
    # older events (TODO)
    event3 = GoogleCalendarEvent.create!(google_calendar: calendar, start_at: "2019-01-01T11:00:00+09:00", end_at: "2019-01-01T13:00:00+09:00", summary: "test title 3", event_id: "125")
    assert { event3.new_schedule == [ "2019-01-01T15:00:00+09:00", "2019-01-01T17:00:00+09:00" ] } # 間違ってる。現在時刻に追従すべき
  end
